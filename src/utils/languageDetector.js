const DUTCH_COMMON_WORDS = [
  'de', 'het', 'een', 'van', 'in', 'is', 'dat', 'en', 'te', 'op',
  'met', 'voor', 'zijn', 'worden', 'als', 'om', 'wordt', 'naar',
  'er', 'bij', 'aan', 'ook', 'maar', 'niet', 'deze', 'door',
  'kan', 'ze', 'uit', 'meer', 'heeft', 'of', 'dit', 'zij',
  'kunnen', 'moet', 'welke', 'andere'
];
